...
import FetchDictionaryLoader from "../../dictionary/loader/FetchDictionaryLoader.ts";

export class FetchTokenizerBuilder extends TokenizerBuilder {
  /**
  ...
  constructor({ dictionaryPath }: { dictionaryPath: string }) {
    super({ dictionaryLoader: new FetchDictionaryLoader(dictionaryPath) });
  }
}
